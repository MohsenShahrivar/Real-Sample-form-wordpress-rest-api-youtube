...
// Register The Save post Route
add_action( 'rest_api_init', function () {

    register_rest_route( 'calc', 'operation', array(
            'methods' => array('GET','POST'),
            'callback' => 'operation_controller',
        )
    );

});

// This is setup a callback function to work with LIKE endpoint
function operation_controller( $params ) {

    $first_number = json_decode($params->get_param('first_number'));
    $second_number = json_decode($params->get_param('second_number'));
